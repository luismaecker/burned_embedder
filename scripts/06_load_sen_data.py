...
def main(observations_before=1, observations_after=1, buffer_months=1, sample_type='positive'):
    ...
    if sample_type == 'positive':
        deforest_df = pd.read_parquet("data/processed/radd/south_america_combined_clean_sampled.parquet")
    elif sample_type == 'negative':
        deforest_df = pd.read_parquet("data/processed/radd/negative_samples_sequential_sampled.parquet")
    else:
